class AppConfig {
  ...
  static const String apiBaseUrl = 'https://api-tecnologias.uidehub.tech/api';
  static const Duration apiTimeout = Duration(seconds: 30);

  // MQTT Configuration
  static const String mqttBrokerUrl = '68.183.174.210';
  static const int mqttBrokerPort = 1883;
  static const String mqttClientId = 'flutter_campus_iot';
  static const String mqttPassword = 'mysecretpws';
